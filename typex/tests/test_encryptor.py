...
class EncryptorTest(unittest2.TestCase):
    def test_constructor(self):
        ...
        self.assertTrue(isinstance(Encryptor(wiring='ZAQXSWCDEVFRBGTNHYMJUKILOP'), Encryptor))
    ...
    def test_wiring_is_alphabetic(self):
        """Check that Encryptor constructor works only if wiring contains alphabet"""
    ...
    def test_wiring_characters_are_unique(self):
        """Check that Encryptor constructor works only if each wiring character is unique""" 
        self.assertTrue(isinstance(Encryptor(wiring='ABCDEFGHIJKLMNOPQRSTUVWXYZ'), Encryptor))
    ...
    def test_initial_position_is_valid(self):
        """Check that Encryptor constructor works only if initial_position is valid"""
    ...
    def test_encrypt_character(self):
        """Check that enctypt_character method of Encryptor works properly"""
    ...
    def test_reverse_encrypt_character(self):
        """Checks that reverse_encrypt_character method of Encryptor works properly"""
        e = Encryptor(wiring=Encryptor.ALPHABET, initial_position=1)
